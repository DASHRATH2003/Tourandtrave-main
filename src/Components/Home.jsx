...
const Home = () => {
  ...
  const vehicles = [
    ...
    },
    {
      ...
      name: "SUV",
      image:
        "https://stimg.cardekho.com/images/carexteriorimages/930x620/Hyundai/Creta/10544/1689589250319/front-left-side-47.jpg",
      seats: "6+1 Seats",
    },
    {
      id: 3,
      name: "Innova Crysta",
      image:
        "https://stimg.cardekho.com/images/carexteriorimages/930x620/Toyota/Innova-Crysta/9612/1677913876084/front-left-side-47.jpg",
      seats: "6+1 Seats",
    },
    {
      id: 4,
      ...
      image:
        "https://5.imimg.com/data5/SELLER/Default/2021/12/MI/EM/ON/3823480/17-seater-luxury-tempo-traveller-500x500.jpg",
      seats: "12+1 Seats",
    },
    {
      id: 5,
      name: "Mini Bus",
      image:
        "https://5.imimg.com/data5/SELLER/Default/2022/9/SZ/VB/CR/47767158/27-seater-bus-rental-services-500x500.jpg",
      seats: "20+1 Seats",
    },
    {
      id: 6,
      name: "Luxury Cars",
      image:
        "https://stimg.cardekho.com/images/carexteriorimages/930x620/Mercedes-Benz/S-Class/10858/1690447163011/front-left-side-47.jpg",
      seats: "4+1 Seats",
    },
  ];
        ...
        <div className="container mx-auto px-4 -mt-8 sm:px-6 relative z-10">
          <div className="max-w-2xl">
            ...
            <p className="text-base md:text-xl font-bold text-gray-200 mb-6 md:mb-8">
              ...
              experience in the industry, we offer customized tour packages,
              seamless bookings, and 24/7 customer support to ensure a
              hassle-free journey.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="w-full md:w-1/2 space-y-3 md:space-y-4 text-gray-600">
                ...
                <p className="text-sm md:text-base font-bold">
                  ...
                  safely. Varshadhaara Tours and Travels is a company that
                ...
                <p className="text-sm md:text-base font-bold">
                  ...
                  background-verified, ensuring a secure travel experience.
              ...
              <div className="w-full md:w-1/2 mt-6 md:mt-0">
                <div className="relative rounded-lg overflow-hidden shadow-xl">
                  <img
                    src="https://plus.unsplash.com/premium_photo-1683140957131-011200b4feeb?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Y29ycG9yYXRlJTIwbWVldGluZ3xlbnwwfHwwfHx8MA%3D%3D"
                    alt="Our Office"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full border-2 border-gray-200 flex items-center justify-center">
                <img
                  src="https://img.icons8.com/ios/50/car.png"
                  alt="Mobility"
                  className="w-8 h-8"
                />
              </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full border-2 border-gray-200 flex items-center justify-center">
                <img
                  src="https://img.icons8.com/ios/50/conference.png"
                  alt="Employee"
                  className="w-8 h-8"
                />
              </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full border-2 border-gray-200 flex items-center justify-center">
                <img
                  src="https://img.icons8.com/ios/50/process.png"
                  alt="Operations"
                  className="w-8 h-8"
                />
              </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full border-2 border-gray-200 flex items-center justify-center">
                <img
                  src="https://img.icons8.com/ios/50/clock.png"
                  alt="Real-time"
                  className="w-8 h-8"
                />
              </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full border-2 border-gray-200 flex items-center justify-center">
                <img
                  src="https://media.istockphoto.com/id/953520974/vector/tick-mark-approved-icon-shield-vector-on-white-background.jpg?s=612x612&w=0&k=20&c=lalLRIXMNvWP6JuqHjoz_h0q-iQXSgOgI5pztVZ6SN8="
                  alt="Safe Drop"
                  className="w-8 h-8"
                />
              </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full border-2 border-gray-200 flex items-center justify-center">
                <img
                  src="https://img.icons8.com/ios/50/money-bag.png"
                  alt="Cost"
                  className="w-8 h-8"
                />
              </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full border-2 border-gray-200 flex items-center justify-center">
                <img
                  src="https://img.icons8.com/ios/50/driver.png"
                  alt="Drivers"
                  className="w-8 h-8"
                />
              </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full border-2 border-gray-200 flex items-center justify-center">
                <img
                  src="https://img.icons8.com/ios/50/radar.png"
                  alt="Tracking"
                  className="w-8 h-8"
                />
              </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full border-2 border-gray-200 flex items-center justify-center">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR95-_8PBew2duvk1E2tKAUxqmuXd4ZMmt0GUGBmKCCWrPjKQl2RdZtfPt4Wxo9qB1RY-k&usqp=CAU"
                  alt="Mobile"
                  className="w-8 h-8"
                />
              </div>
